  ...
  import AppliedCl from "../pages/Security Pages/AppliedClPage/appliedcl";
  ...
  import MyComponents from "../pages/Security Pages/demopage/mycomponenet";
  ...
  const userRoutes = [
    ...
    { path: "/applied-cl", component: <AppliedCl /> },
    ...
    { path: "/my-component", component: <MyComponents />},

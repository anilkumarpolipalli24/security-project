      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/applied-cl" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Applied CL'S")}</span>
              </Link>
            </li>
            <li>
              <Link to="/applied-od" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Applid OD's")}</span>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/coustom-month-report" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Coustom Month Report")}</span>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/edit-roaster" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("Edit Roaster")}</span>
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/my-component" className=" waves-effect">
                <i className="mdi mdi-calendar-check"></i>
                <span>{props.t("my compo")}</span>
              </Link>
            </li>

            <li className="menu-title">{props.t("Ending Components")}</li>
